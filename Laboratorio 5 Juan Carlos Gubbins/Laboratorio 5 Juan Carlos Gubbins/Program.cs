...
namespace Laboratorio_5_Juan_Carlos_Gubbins
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //4- Suscribir OnEmailSent de user para que escuche el evento EmailSended enviado por MailSender
            mailSender.EmailSended += user.OnEmailSent;
            //4- Suscribir OnEmailVerified de server para que escuche el evento enviado por User
